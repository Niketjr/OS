...
void fifoPR(int pages[], int numPages, int numFrames) {
...
void optPR(int pages[], int numPages, int numFrames) {
    int frames[numFrames];
    int pageFaults = 0;
...
void lruPRm (int pages[], int numPages, int numFrames) {
    int frames[numFrames];
    int pageFaults = 0;
...
int main() {
    ...
    fifoPR(pages, numPages, numFrames);
    optPR(pages, numPages, numFrames);
    lruPR(pages, numPages, numFrames);
